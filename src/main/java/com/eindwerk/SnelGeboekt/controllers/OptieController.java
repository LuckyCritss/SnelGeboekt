...
public class OptieController {
    ...
    @GetMapping("/instellingen/medewerker/{id}/keuzemogelijkheden/edit/")
    ...
    @PostMapping("/instellingen/medewerker/{id}/keuzemogelijkheden/edit")
    public String processForm(@PathVariable int id, @Valid @ModelAttribute Optie optie, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
    ...
    @GetMapping("/instellingen/medewerker/{id}/keuzemogelijkheden/delete")
